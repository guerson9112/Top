package com.example.guerson.top;
...
public class MainActivity extends AppCompatActivity implements OnItemClickListener {
    ...
    private void generateArtist() {
        ...
        String[] fotos = {"https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/RachelMcAdamsO7TIFF.jpg/200px-RachelMcAdamsO7TIFF.jpg",
    ...
    /**
     * Métodos implemnetados por la interface OnItemClickListener
     **/
